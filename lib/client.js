window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".UVjcUW_panel{border-top:1px solid var(--border-color,#e0e0e0);color:var(--text-normal,#333);padding:8px 12px;font-size:13px}.UVjcUW_header{color:var(--text-muted,#666);text-transform:uppercase;letter-spacing:.3px;justify-content:space-between;align-items:center;margin-bottom:8px;font-size:12px;font-weight:600;display:flex}.UVjcUW_iconBtn{cursor:pointer;color:var(--text-muted,#666);background:0 0;border:none;border-radius:4px;padding:2px 4px;font-size:14px}.UVjcUW_iconBtn:hover{background:var(--background-modifier-hover,#eee)}.UVjcUW_error{color:#dc2626;background:#fef2f2;border-radius:4px;margin-bottom:6px;padding:4px 6px;font-size:11px}.UVjcUW_breadcrumb{color:var(--text-muted,#666);white-space:nowrap;text-overflow:ellipsis;margin-bottom:6px;font-size:11px;overflow:hidden}.UVjcUW_sep{color:var(--text-muted,#666);margin:0 2px}.UVjcUW_crumbBtn{color:var(--text-muted,#666);cursor:pointer;background:0 0;border:none;padding:0;font-size:11px}.UVjcUW_crumbBtn:hover{color:var(--text-normal,#333);text-decoration:underline}.UVjcUW_tree{margin:0 0 8px;padding:0;font-size:12px;list-style:none}.UVjcUW_tree li{margin:1px 0}.UVjcUW_row{cursor:pointer;text-align:left;width:100%;color:var(--text-normal,#333);background:0 0;border:none;border-radius:4px;align-items:center;gap:6px;padding:3px 6px;font-size:12px;display:flex}.UVjcUW_row:hover{background:var(--background-modifier-hover,#eee)}.UVjcUW_rowLabel{text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.UVjcUW_empty{color:var(--text-muted,#666);padding:4px 6px;font-size:11px;font-style:italic}.UVjcUW_actions{gap:6px;margin-bottom:8px;display:flex}.UVjcUW_actionBtn{border:1px solid var(--border-color,#e0e0e0);background:var(--background-primary,#fff);color:var(--text-normal,#333);cursor:pointer;border-radius:4px;flex:1;padding:4px 8px;font-size:11px}.UVjcUW_actionBtn:hover{background:var(--background-modifier-hover,#eee)}.UVjcUW_section{border-top:1px solid var(--border-color,#e0e0e0);margin-bottom:8px;padding-top:8px}.UVjcUW_sectionTitle{color:var(--text-muted,#666);text-transform:uppercase;letter-spacing:.3px;margin-bottom:4px;font-size:10px;font-weight:600}.UVjcUW_quickLinks{flex-direction:column;gap:2px;display:flex}.UVjcUW_linkBtn{cursor:pointer;text-align:left;width:100%;color:var(--text-normal,#333);background:0 0;border:none;border-radius:4px;align-items:center;gap:6px;padding:3px 6px;font-size:12px;display:flex}.UVjcUW_linkBtn:hover{background:var(--background-modifier-hover,#eee)}.UVjcUW_toolList{margin:0;padding:0;font-size:11px;list-style:none}.UVjcUW_toolList li{color:var(--text-normal,#333);padding:1px 0}.UVjcUW_toolList code{background:var(--background-modifier-form-field,#f5f5f5);border-radius:3px;padding:1px 3px;font-family:monospace;font-size:10px}.UVjcUW_info{color:var(--text-muted,#666);padding:4px 0;font-size:11px}";
		...
		var ObsidianMemoryPanel_module_css_default = {
			...
			"empty": "UVjcUW_empty",
			"rowLabel": "UVjcUW_rowLabel",
			"actions": "UVjcUW_actions",
			"toolList": "UVjcUW_toolList",
			"row": "UVjcUW_row",
			"sectionTitle": "UVjcUW_sectionTitle",
			"linkBtn": "UVjcUW_linkBtn",
			"crumbBtn": "UVjcUW_crumbBtn",
			"actionBtn": "UVjcUW_actionBtn",
			"iconBtn": "UVjcUW_iconBtn",
			"panel": "UVjcUW_panel",
			"breadcrumb": "UVjcUW_breadcrumb",
			"info": "UVjcUW_info",
			"tree": "UVjcUW_tree",
			"section": "UVjcUW_section",
			"quickLinks": "UVjcUW_quickLinks",
			"error": "UVjcUW_error"
		};
		//#endregion
